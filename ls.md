...
* ls command and its Aliases. We have made alias for ls command, when we execute ls command it’ll take -l option by default and display long listing as mentioned earlier.     
`$ alias l="ls -l"`
```
alias l="ls -l"
